...
const optVal = (e:[any, any]) =>
  e[1] ? `${e[0]}/${e[1]}/` : "";

  const optValNum = (e:[any|'var_id', any|1] ) => e[1] > -1 ? `${e[0]}/${e[1]}/` : ''
...
export const getSubject = (req:req)=> fetch(`https://webapi.bps.go.id/${version}/api/list/model/subject/domain/${req.domain}/${
...
}key/${req.apiKey}/`).then(r => r.json())


export const getSubCat = (req={
    domain: default_domain,
    lang: 'ind',
    page: 0,
})=>fetch(
...
export const getVervar = (req:req={
        domain: default_domain,
        var: '',
        page: 0,
        apiKey: apiKey
...
export const getPeriodData = (req:req = {
    domain: default_domain,
    var: '',
    page: 0,
    apiKey: apiKey
...
export const getDerPeriodData = (req:req={
    domain: default_domain,
    var: '',
    page: 0,
    apiKey: apiKey
...
export const getDerVar = (req:req = {
    domain: default_domain,
    var: '',
    page: 0,
    apiKey:apiKey
...
export const getDynData = (req:req={
    domain: default_domain,
    var: '',
    turvar: 0,
    vervar: 0,
